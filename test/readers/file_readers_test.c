...
void read_file_port(void) {
    ...
    /* TRACE_S7_DUMP("expected", readers_expected); */

    flag = APPLY_2("equal?", actual, readers_expected);
...
int main(int argc, char **argv)
{
    ...
    data_fname_str = "test/readers/case010.dune";
    readers_expected = read_expected("test/readers/case010.expected");
